...
setwd( "/scratch/u010/c_constant/Documents/BlogPosts/HistoricalEventsData" )
...
# Get a measure of how many sources and or targets an entry has. Presumably, the bigger the event, the more sources it's picked up by, and the more targets it involves.
...
tail( full_BBC_events_with_meta )
